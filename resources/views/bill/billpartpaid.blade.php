        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    {{-- @can('اضافة فاتورة') --}}
                        <a href="bill/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $bill->product }}</td>
                                    <td><a
                                        href="{{ url('billdetail') }}/{{ $bill->id }}">{{ $bill->section->name }}</a>
                                     </td>
                                    <td>{{ $bill->Discount }}</td>
                                    <td>{{ $bill->Rate_VAT }}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $bill->id }}"
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    @can('تعديل الفاتورة')
                                                        <a class="dropdown-item"
                                                            href=" {{ url('edit_invoice') }}/{{ $bill->id }}">تعديل
                                                            الفاتورة</a>
                                                    @endcan
                                                    ...
                                                    @can('طباعةالفاتورة')
                                                        <a class="dropdown-item" href="Print_invoice/{{ $bill->id }}"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('bill.destroy','test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                </div>
