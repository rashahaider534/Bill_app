...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $bill->id]) }}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="bill_number"
                                    title="يرجي ادخال رقم الفاتورة" value="{{ $bill->bill_number }}" required
                                    readonly>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="bill_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $bill->bill_Date }}" required readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $bill->Due_date }}" required readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control" readonly>
                                    <option value="{{ $bill->product }}"> {{ $bill->product }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                    ...
                                    value="{{ $bill->Amount_collection }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value="{{ $bill->Amount_Commission }}" required readonly>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="Discount"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value="{{ $bill->Discount }}" required readonly>
                            </div>
