        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'bill')) }}">قائمة الفواتير</a></li>
                        @endcan
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'billpaid')) }}">الفواتير المدفوعة</a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'billunpaid')) }}">الفواتير الغير مدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'billpartpaid')) }}">الفواتير المدفوعة
                                    حزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">تقارير</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'section')) }}">اقسام </a></li>
                        @endcan
                        @can('المنتجات')
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                            href="{{ url('/' . ($page = 'underconstruction')) }}">UnderConstruction</a>
                    </li>
